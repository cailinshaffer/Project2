// create and instance of express routers
...
//GET/users/new -- serves a for to create a new user
...
router.post('/', async (req, res) => {
    try {
        //based on the infor in the req.body, find or create user
        ...
        //log user in when one created (store use id as a cookie in the browser)
...
//GET /users/login -- render a login form thats POSTS to a users/logins
router.get('/login', (req, res) => {
   res.render('users/login.ejs', {
    message: req.query.message ? req.query.message : null
   })
})
// POST /users/login -- ingest data from form rendered from form rendered @ GET /users/login
